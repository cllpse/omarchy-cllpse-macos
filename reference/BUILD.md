...
| blur size / passes | `6` / `3` | effective spread ≈ size × 2^(passes−1), so ≈24 — tighter than section 5's own 8/3 (≈32) [chosen]. 12/4 (≈96), 10/4, 8/4 and 7/4 all washed the backdrop out; a tight blur keeps the structure that makes it read as glass over something rather than a flat field. The 4th pass was dropped once it stopped earning its ~30% cost |
