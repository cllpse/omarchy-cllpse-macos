...
decoration. Nothing is shared with `omarchy-cllpse-theme-dark`.
...
```bash
git clone https://github.com/cllpse/omarchy-cllpse-theme-light ~/src/omarchy-cllpse-theme-light
ln -sfn ~/src/omarchy-cllpse-theme-light ~/.config/omarchy/themes/omarchy-cllpse-theme-light
omarchy theme set omarchy-cllpse-theme-light
```
