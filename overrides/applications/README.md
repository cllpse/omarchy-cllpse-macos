...
The script is [`applications.sh`](applications.sh). It is runnable on its own and is also
...
## 1. _figma_dir=~/Applications/figma-desktop
...
## 2. skip "WARNING: $_figma_dir/AppRun is not the app's own launcher and th
